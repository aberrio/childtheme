			...
			<div id="content" class="clearfix row">
				...
				<div id="main" class="col-sm-12 clearfix" role="main">
					...
					<?php if (is_category()) { ?>
						...
						<div class="pull-right"><h3><?php echo do_shortcode( '[searchandfilter fields="grades" headings="Grades"]' ); ?></h3></div>
					...
					<?php } elseif (is_tag()) { ?> 
						<h1 class="archive_title h2">
							<span></span> <?php single_tag_title(); ?>
						</h1>
					...
					<?php $query = new WP_Query( array( 'milestones' ) ); ?>
